...
class WeatherProcessor():
    ...
    def user_choice(self):
        ...
        try:
            ...
            logging.warning("Error: user_choice: Error with input: ", error)
        try:
            match option:
                case "1":
                    self.update_weather()            
            ...
            logging.warning("Error: user_choice: Processing user selection: ", error)
    ...
    def update_weather(self):
        ...
        try:
            ...
            logging.warning("Error: update_weather: Initiliazing variables: ", error)
        ...
        try:
            while end_check:
                ...
                try:
                    ...
                    logging.warning("Error: update_weather: Adding data to weather dictionary: ", error)
            ...
            logging.warning("Error: update_weather: Looping through scraper: ", error)
        ...
        try:
            ...
            logging.warning("Error: update_weather: Saving weather to database: ", error)
    ...
    def download_weather(self):
        ...
        try:
            ...
            logging.warning("Error: download_weather: Initializing variables: ", error)
        ...
        try:
            while end_check:
                ...
                try:
                    ...
                    logging.warning("Error: download_weather: Adding data to weather dictionary: ", error)
            ...
            logging.warning("Error: download_weather: Looping through scraper: ", error)
        ...
        try:
            ...
            logging.warning("Error: download_weather: Saving weather to database: ", error)
        print("Saved to database.")
    ...
    def generate_box_plot(self):
        ...
        try:
            ...
            logging.warning("Error: generate_box_plot: Building variables: ", error)
        
        try:
            weather = self.db.fetch_box_data(range)
        except Exception as error:
            logging.warning("Error: generate_box_plot: Fetching data from database: ", error)
        try:
            self.plot.box_plot(weather)
        except Exception as error:
            logging.warning("Error: generate_box_plot: Creating box plot: ", error)            
    ...
    def generate_line_plot(self):
        ...
        try:
            ...
            logging.warning("Error: generate_line_plot: Building variables: ", error)

        try:
            weather = self.db.fetch_line_data(date)
        except Exception as error:
            logging.warning("Error: generate_line_plot: Fetching data from database: ", error)
        try:
            self.plot.line_plot(weather)
        except Exception as error:
            logging.warning("Error: generate_line_plot: Creating box plot: ", error)
